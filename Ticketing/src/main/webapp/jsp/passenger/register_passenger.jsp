...
*/
	...
	<div class="container col-md-5 col-md-offset-3 mt-3" style="overflow: auto; margin-top: 5m;">
			...
			<form action="<%=request.getContextPath()%>/PassengerVerify" method="post">
				...
				<div class="input-group input-group" style="margin-bottom: 2em">
					<input type="date" id="birthday" name="birthday" onchange="ageCount()" class="input1 form-control"
						style="margin-right: 10px; width: 80px" required min="1900-01-01"> <input type="text" id="age"
						name="age" placeholder="Age" class="input1 disabled" style="margin-right: 10px; width: 70px;"
						readonly> <input type="tel" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" placeholder="Contact Number"
				...
				<div class="input-group input-group " id="floatingInput" style="margin-bottom: 2em">
					<input type="email" placeholder="Email" name="email" class="input1 form-control"
						style="margin-right: 30px;" required maxlength="30"> <input type="password"
						placeholder="Password" name="password" class="input1 form-control" required minlength="8"
						maxlength="20">
				</div>
